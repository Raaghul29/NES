...
public class AlertsFromSchool extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alerts_from_school);
        ...
        nv.setNavigationItemSelectedListener(AlertsFromSchool.this);
        ...
        if (id == R.id.nav_logout){
            ...
            alertDialogBuilder.setMessage("Confirm Logout?").setCancelable(false).setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    Intent intent = new Intent(AlertsFromSchool.this, LoginActivity.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                    startActivity(intent);
                    AlertsFromSchool.this.finish();
