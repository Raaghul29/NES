...
public class FeeDetails extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    private RecyclerView fee_view;
    private FeeCustomAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        feeDispList = (ArrayList<FeesBase>)args.getSerializable("feeDispList");


        fee_view = (RecyclerView)findViewById(R.id.Fee_recycler_view);
        gridLayoutManager = new GridLayoutManager(this,1);
        fee_view.setLayoutManager(gridLayoutManager);
        adapter = new FeeCustomAdapter(this,feeDispList);
        fee_view.setAdapter(adapter);


        Toolbar toolbar = findViewById(R.id.toolbar);
        nv = (NavigationView)findViewById(R.id.nav_my_profile_parent);
        nv.setNavigationItemSelectedListener(FeeDetails.this);
        ...
        if (id == R.id.nav_logout){
            ...
            alertDialogBuilder.setMessage("Confirm Logout?").setCancelable(false).setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    Intent intent = new Intent(FeeDetails.this, LoginActivity.class);
